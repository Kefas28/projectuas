...
<label><font size ="6"><u><center>Laporan Penanggung Jawab</center></u></font>
</label><p>&nbsp;</p>
...
<tr>
    ...
    <th style ="border-right: 1px solid gray">Kode Penanggung Jawab</th>
    <th style ="border-right: 1px solid gray">Nama Penanggung Jawab</th>
    <th style ="border-right: 1px solid gray">Alamat</th>
    <th style ="border-right: 1px solid gray">No HP</th>
...
<td align ="center" style="border-right: 1px solid gray; border-top: 1px 
solid gray; padding: 3px 5px; "><?php echo $row['kd_pj'] ?></td> 
<td align ="center" style="border-right: 1px solid gray; border-top: 1px 
solid gray; padding: 3px 5px; "><?php echo $row['nm_pj'] ?></td> 
<td  style="border-right: 1px solid gray; border-top: 1px 
solid gray; padding: 3px 5px; "><?php echo $row['alamat'] ?></td> 
<td  style="border-right: 1px solid gray; border-top: 1px 
solid gray; padding: 3px 5px; "><?php echo  $row['nohp'] ?></td> 
<td  style="border-right: 1px solid gray; border-top: 1px 
solid gray; padding: 3px 5px; "><?php echo $row['stts'] ?></td> 
