...
<label><font size ="6"><u><center>Laporan Data Kas Masuk</center></u></font>
</label><p>&nbsp;</p>
...
<tr>
    ...
    <th style ="border-right: 1px solid gray">Penerima</th>
</tr>

<?php
include 'database.php';
$db = new database();
$laporan_kas_masuk = $db->laporan_kas_masuk();
   $no = 1;
   foreach($laporan_kas_masuk as $row){
    ?>
<tr>
...
<td align ="center" style="border-right: 1px solid gray; border-top: 1px 
solid gray; padding: 3px 5px; "><?php echo $row['tgl_masuk'] ?></td> 
...
<td align ="center" style="border-right: 1px solid gray; border-top: 1px
solid gray; padding: 3px 5px; ">Rp. <?php echo $row['jumlah'] ?></td> 
<td  style="border-right: 1px solid gray; border-top: 1px 
solid gray; padding: 3px 5px; "><?php echo $row['ket_m'] ?></td>
